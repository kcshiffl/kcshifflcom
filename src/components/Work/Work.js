...
const Work = () => {
  ...
  return (
    <div className='work'>
      <ProjectLeft title='Personal Website' image={kcshifflcom} description={kcshifflcom_desc} technologies = {kcshifflcom_technologies} github={kcshifflcom_git} />
      <ProjectRight title='Djisktra Shortest Path Graph' image={djikstra} description={djikstra_desc} technologies = {djikstra_technologies} github={djikstra_git} />
      ...
      <ProjectRight title='Movie Recommender System' image={movie} description={movie_desc} technologies = {movie_technologies} github={movie_git}/>
    </div>
  )
}
